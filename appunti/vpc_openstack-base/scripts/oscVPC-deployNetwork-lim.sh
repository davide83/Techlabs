...
# Create the regional Subnet 10-42-16-0_24
VPC_SUBNET_NAME=pnSbnt-$VPC_SEGMENT_ID-$VPC_REGION_NAME-10-42-16-0_24
openstack subnet create \
    --description "Techlabs' VPC (vlan id $VPC_SEGMENT_ID) Private Subnet 10.42.16.0/24 in $VPC_REGION_NAME region" \
    --network $VPC_NET_NAME \
    --subnet-range 10.42.16.0/24 \
    --dhcp \
    --allocation-pool start=10.42.16.64,end=10.42.16.254 \
    --gateway 10.42.16.1 \
